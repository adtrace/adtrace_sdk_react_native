...
final class AdTraceUtil {
    ...
    public static WritableMap eventSuccessToMap(AdTraceEventSuccess eventSuccess) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap eventFailureToMap(AdTraceEventFailure eventFailure) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap sessionSuccessToMap(AdTraceSessionSuccess sessionSuccess) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap sessionFailureToMap(AdTraceSessionFailure sessionFailure) {
        WritableMap map = Arguments.createMap();
    ...
    public static Map<String, Object> toMap(@Nullable ReadableMap readableMap) {
        ...
        while (iterator.hasNextKey()) {
            ...
            if (value == null) {
                AdTraceFactory.getLogger().warn("Null parameter inside key-value pair with key: " + key);
                continue;
            }
        ...
        for (int index = 0; index < readableArray.size(); index++) {
            ...
            switch (readableType) {
                ...
                case Array: 
                    ...
                    break; 
                default: 
                    AdTraceFactory.getLogger().error("Could not convert object with index: " + index + ".");
            } 
        } 
    ...
    private static Object toObject(@Nullable ReadableMap readableMap, String key) {
        ...
        switch (readableType) {
            ...
            case Array: 
                ...
                break; 
            default: 
                AdTraceFactory.getLogger().error("Could not convert object with key: " + key + ".");
        }
